...
Hieronder wordt de tijdsafhankelijkheid van het geactiveerde complex weergegeven wanneer er geen auto-regulatie van de glucocorticoide receptor was. De medicatie (MPL) heeft nu dus geen effect heeft op de synthese van het receptor mRNA. Het model wordt eerst aangepast door de IC50_Rm waarde eruit te halen. 
...
Hieronder wordt de tijdsafhankelijkheid van de receptor mRNA concentratie wanneer je stopt met de medicatie weergegeven. Nadat de de reacties gestabiliseerd zijn, steady state, wordt de D waarde op 0 gezet. Hierna wordt een nieuwe evenwichtsverhouding gevormd: t_steady_second. 
